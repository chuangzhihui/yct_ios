...
{
    UIFont *emojiFont = [UIFont systemFontOfSize:20 weight:(UIFontWeightBold)];
    //先判断text是否存在
    if (self.length == 0) {
...
//                textAttachment.bounds = CGRectMake(0, -(emojiFont.lineHeight-emojiFont.pointSize)/2, emojiFont.pointSize, emojiFont.pointSize);
                textAttachment.bounds = CGRectMake(0, -(emojiFont.lineHeight-emojiFont.pointSize), emojiFont.pointSize, emojiFont.pointSize);
