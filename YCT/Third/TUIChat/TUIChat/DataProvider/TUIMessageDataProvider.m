...
//    ];
    ...
    customMessageInfo = @[
        @{BussinessID : @"bussiness_follow",
          TMessageCell_Name :  @"YCTAttentionCell",
          TMessageCell_Data_Name : @"YCTAttentionCellData"},
        @{BussinessID : @"bussiness_Video",
          TMessageCell_Name :  @"YCTChatVideoCell",
          TMessageCell_Data_Name : @"YCTChatVideoCellData"}
    ];
}
...
+ (V2TIMMessage *)getVideoMessageWithURL:(NSURL *)url {
    ...
    V2TIMMessage *message = [[V2TIMManager sharedInstance] createVideoMessage:videoPath type:url.pathExtension duration:(int)duration snapshotPath:imagePath];
    return message;
}
