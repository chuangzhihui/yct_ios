//
//  YCTOtherPeopleFansListViewController.m
//  YCT
//
...
@interface YCTOtherPeopleFansListViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, copy) NSString *userId;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) YCTOtherPeopleFanslistViewModel *viewModel;
@end

@implementation YCTOtherPeopleFansListViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = YCTLocalizedTableString(@"others.title.hisFans", @"Mine");
    [self requestFans];
}
...
- (YCTOtherPeopleFanslistViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[YCTOtherPeopleFanslistViewModel alloc] initWithUserId:self.userId];
    }
    return _viewModel;
}
