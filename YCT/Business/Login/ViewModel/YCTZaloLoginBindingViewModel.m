//
//  YCTZaloLoginBindingViewModel.m
//  YCT
//
...
@interface YCTZaloLoginBindingViewModel ()
...
@implementation YCTZaloLoginBindingViewModel
    ...
    if (!_bindCommad) {
        ...
        _bindCommad = [[RACCommand alloc] initWithEnabled:[[RACSignal merge:@[RACObserve(self, mobile),RACObserve(self, smsCode)]] map:^id(id value) {
            ...
            return [RACSignal createSignal:^RACDisposable * _Nullable(id<RACSubscriber>  _Nonnull subscriber) {
                YCTApiZaloLoginBinding *api = [[YCTApiZaloLoginBinding alloc] init];
                ...
                [api startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
                    NSLog(@"返回信息:%@",request.responseString);
