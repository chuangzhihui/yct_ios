...
-(UIImage*)scaleToFillSize:(CGSize)newSize
{
  ...
  /// Create an ARGB bitmap context
    ...
    CGContextRef bmContext = CGBitmapContextCreate(NULL, destWidth, destHeight, 8/*Bits per component*/, destWidth * kNyxNumberOfComponentsPerARBGPixel, CGColorSpaceCreateDeviceRGB(), kCGBitmapByteOrderDefault | alphaInfo);
