...
{
    UIAlertController * controller = [self showInViewController:viewController
                                                      withTitle:title
                                                        message:message
                                                 preferredStyle:UIAlertControllerStyleAlert
                                              cancelButtonTitle:cancelButtonTitle
    ...
    if (configurationTextFiled) {
        [controller addTextFieldWithConfigurationHandler:configurationTextFiled];
    }
    return controller;
}
